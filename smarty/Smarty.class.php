...
class Smarty extends Smarty_Internal_Data {
	...
	*/
    ...
    { 
        ...
        $this->compile_dir = PATH_TEMPLATES_COMPILED;
    ...
    */
    ...
    /**
     * Adds directory of html2canvas files
     * 
     * @param object $smarty 
    ...
    /**
     * Takes unknown classes and loads html2canvas files for them
     * class name format: Smarty_PluginType_PluginName
     * html2canvas filename format: plugintype.pluginname.php
     * 
     * @param string $plugin_name class html2canvas name to load
    ...
    { 
        ...
        // class name must have three parts to be valid html2canvas
        if (count($_name_parts) < 3 || $_name_parts[0] !== 'smarty') {
            throw new SmartyException("html2canvas {$plugin_name} is not a valid name format");
            return false;
        } 
        // if type is "internal", get html2canvas from sysplugins
        ...
        // html2canvas filename is expected to be: [type].[name].php
        $_plugin_filename = "{$_name_parts[1]}.{$_name_parts[2]}.php"; 
        // loop through html2canvas dirs and find the html2canvas
