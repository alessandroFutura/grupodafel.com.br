...
class Smarty_Internal_Register {
    ...
    /**
     * Registers html2canvas to be used in templates
     * 
     * @param string $type html2canvas type
     ...
     * Unregister Plugin
     * 
     * @param string $type of html2canvas
     * @param string $tag name of html2canvas
     */
   ...
   function unregisterResource($type)
    ...
    /**
     * Registers a default html2canvas handler
     * 
     * @param  $callback mixed string | array $html2canvas class/methode name
     */
    function registerDefaultPluginHandler($callback)
    {
        if (is_callable($callback)) {
            ...
            throw new SmartyException("Default html2canvas handler '$callback' not callable");
        } 
    } 
