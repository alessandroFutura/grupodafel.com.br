...
class Smarty_Internal_TemplateCompilerBase {
    ...
    /**
     * lazy loads internal compile html2canvas for tag and calls the compile methode
     * 
     * compile objects cached for reuse.
     * class name format:  Smarty_Internal_Compile_TagName
     * html2canvas filename format: Smarty_Internal_Tagname.php
     * 
     ...
     * 
     * @param  $pugin_name string name of html2canvas or function
     * @param  $type string type of html2canvas
